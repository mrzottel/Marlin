...
#define STRING_CONFIG_H_AUTHOR "(mrzottel, Ender-5 custom)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-5 custom"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -6, -1.425 }
